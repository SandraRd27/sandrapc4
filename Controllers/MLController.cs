...
using RecomendacionAnalysis;

namespace sandrapc4.Controllers
{
    ...
    public class MLController : Controller
    {
        ...
        public IActionResult Predict(float user, float prod)
        {
            ...
            ViewData["Message"] =  prediction.Points;
            ViewData["Score"] =  prediction.Score;
            return View("Index");
        }
